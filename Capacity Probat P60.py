...
plt.axhline(y=182.75, color='black', linestyle='--', linewidth=2)
...
plt.text(0.22, 1.05, 'Probat P60 (in kg/h)', color='black', weight='bold', fontsize=16, ha='left', transform=plt.gca().transAxes)
...
plt.text(len(pivot_data.index) - 0.9, 182.75, 'Occupancy rate', color='black', va='center', ha='left', fontsize=11, weight='bold')
