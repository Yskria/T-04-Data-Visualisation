...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 17 11:16:55 2024
...
plt.text(0.15, 1.02, 'Medium Roast (in kg)', color='black', weight='bold', fontsize=16, transform=plt.gca().transAxes)
...
plt.text(middle_index, (filtered_data['Load weight p/batch'][middle_index] + filtered_data['Final weight /pbatch'][middle_index]) / 2 + 3, 
         f'{average_fill_between:.1f}%', color='black', va='center', ha='center', fontsize=16, weight='bold')
