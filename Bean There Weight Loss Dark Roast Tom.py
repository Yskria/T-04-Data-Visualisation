...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 17 12:20:13 2024
...
filtered_data = Roasting[Roasting['Product type'] == 'Dark Roast']
...
plt.text(0.15, 1.02, 'Dark Roast (in kg)', color='black', weight='bold', fontsize=16, transform=plt.gca().transAxes)
