...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 18 20:50:38 2024
...
pivot_data_2024 = (pivot_data_2023 * 1.1).rename(index=lambda x: x + ' 24')  # Renaming to indicate 2024
pivot_data_2025 = (pivot_data_2024 * 1.1).rename(index=lambda x: x + ' 25')  # Renaming to indicate 2025
...
plt.ylim(0, 500)
plt.yticks(range(0, 501, 100))  # Y-axis steps of 20
...
plt.gca().text(-0.045, 1.05, 'Forecast Utilization Probat Px120 (in kg/h)', color='black', fontsize=16, weight='bold', transform=plt.gca().transAxes)
...
plt.text(1.5, -35, '2023', ha='center', fontsize=12, color='black', weight='bold')  # Middle of Q1
plt.text(5.5, -35, '2024', ha='center', fontsize=12, color='black', weight='bold')  # Middle van Q2
plt.text(9.5, -35, '2025', ha='center', fontsize=12, color='black', weight='bold')  # Middle van Q3
